...
<br>
<!-- End Navigation -->
<form action="buynowserver.php" method="post" enctype="multipart/form-data" class="was-validated">
...
<div class="form-group">
          ...
          <input type="text" class="form-control"  placeholder="Type here" name = "email" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
<label for="uname">Mobile no</label>
          <input type="number" class="form-control"  placeholder="Type here" name = "mobileno" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
<label for="uname">Address</label>
          <input type="text" class="form-control"  placeholder="Type here" name = "address" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
          <label for="uname">City</label>
          <input type="text" class="form-control"  placeholder="Type here" name = "city" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
          <label for="uname">Pin Code</label>
          <input type="number" class="form-control"  placeholder="Type here" name = "pincode" style=" border-color:#1A2A4C;" required>
</div>
<button class="btn btn-primary button1" style = "width:100%"  type="submit" >Finish</button>
    <br><br>
