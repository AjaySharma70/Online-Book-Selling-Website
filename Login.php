...
<!-- End Navigation -->
<form action="LoginServer.php" method="post" enctype="multipart/form-data" class="was-validated">
...
<button class="btn btn-primary button1" style = "width:100%"  type="submit">LOGIN</button>
    <br><br>
    <p class="text-center text-secondary">Already have an account ?  <a href="sign.php" style="color:#008B8B;">Register!</a></p>
