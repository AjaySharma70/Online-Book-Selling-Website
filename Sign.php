  ...
  <button class="navbar-toggler ml-auto" data-target="#myMenu" data-toggle="collapse" aria-expanded="true" >
    ...
    <div class="collapse navbar-collapse" id="myMenu">
      <ul class="navbar-nav pl-5 custom-nav">
        ...
        <li class="nav-item"><a href="index.php" class="nav-link" style="color: #3c036b ;">About Us</a></li>
...
<br>
<!-- End Navigation -->
<form action="SignInServer.php" method="post" enctype="multipart/form-data" class="was-validated">
<div class="form-group">
          <label for="uname">Name</label>
          <input type="text" class="form-control"  placeholder="Type here" name = "name" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
          <label for="uname">Email</label>
          <input type="text" class="form-control"  placeholder="Type here" name = "username" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
          <label for="uname">Password</label>
          <input type="password" class="form-control"  placeholder="Type here" name = "password" style=" border-color:#1A2A4C;" required>
</div>
<div class="form-group">
          <label for="uname">Confirm Password</label>
          <input type="password" class="form-control"  placeholder="Type here" name = "confirmpassword" style=" border-color:#1A2A4C;" required>
</div>
<button class="btn btn-primary button1" style = "width:100%"  type="submit" name="signin">SIGN UP</button>
    <br><br>
    <p class="text-center text-secondary">Already have an account ?  <a href="login.php" style="color:#008B8B;">Login!</a></p>
