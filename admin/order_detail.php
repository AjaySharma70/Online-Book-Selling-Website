              ...
              <div class="col-lg-12">
                <div class="card px-2">
                  <div class="card-body">
                    ...
                    ?>
                    <select class="form-control" style="width:200px;" name="order_status" id="order_status" onchange="updateOrderStatus()">
                      ...
                      ?>
                      <select class="form-control" style="width:200px;" name="delivery_boy" id="delivery_boy" onchange="updateDeliveryBoy()">
