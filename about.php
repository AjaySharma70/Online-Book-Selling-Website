      ...
      <ul class="navbar-nav pl-5 custom-nav">
        ...
        <ul >
          <li><a href="Computer.php" class="nav-link" style="color: #3c036b ;">Database</a></li>
           ...
           <li><a href="Mathematics.php" class="nav-link" style="color: #3c036b ;">Mathematics</a></li>
...
<br><br><br><br>
    <section class="static about-sec">
        <div class="container">
            ...
            <div class="img-sec">
                <img src="image/About.jpg"  width="50%" height="40%">
                <p><th>online book shopping is a website on which you can sell,buy and exchange books.
                 It is based on the idea of users selling,buying or exchanging books with other users.</th></p>
                <p><th>Used Book Store shows the ads of books posted by the users who want to sell them.
                  Book Store shows the requests of books placed by the users who want to buy them.</th></p>
            </div>
            <p><th>It is purely based on the concept of providing a platform on which you can get a reasonable price from selling your books.</th></p>
            <p><th>A user can get a good price for his/her books by selling them to the people who need them indeed
Students if willing to buy second hand books at a cheaper price than the market's, should place their requests on online book shopping and buy books from the users who are willing to sell them.</th></p>
            <p><th>
            So,why let your old,used books occupy space in your closet? Why let your already read used books acquire dust and dirt? Register for free and starting posting ads of your books on online book selling.</th></p>
        </div>
    </section>
   <!-- Start Footer-->
